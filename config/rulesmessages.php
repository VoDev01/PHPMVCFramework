...
$rulesMessages = [
    ...
    'same' => 'x field must be the same as current field',
    'size' => 'Field must be exactly the size of x y',
    'string' => 'Field must be a string',
    'exists' => 'Field must exist',
    'unique' => 'Such field is already present',
    'different' => 'Field must have a different value than x field',
